...
function CreateAccount({ username, domain, address, pscMember, arweave, arconnect, keyfile }) {
    ...
    const[savePassport, setSavePassport] = useState('Save Travel Rule SSI Passport')
                    ...
                    <li style={{ marginTop: "4%" }}>
                        ...
                        <form>
                            ...
                            <ul class="actions">
                                ...
                                <li><input type="reset" value="Reset" onClick={ _event => { setIvms101(emptyMessage); setSavePassport('Save Travel Rule SSI Passport'); setPassportButton('button primary') }} /></li>
                            </ul>
                        </form>
                    </li>   
