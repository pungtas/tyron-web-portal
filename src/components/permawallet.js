	...
	return(
		<div id="main">
            ...
            <h2 style={{ width: "100%", textAlign:"center" }} class="major">SSI Permawallet</h2>
                ...
                <p>With an SSI Permawallet, the user must only worry about one private key: their <code>SSI permaweb secret key</code>. This improved user experience also brings to the user peace of mind that all their other private keys and personal information are encrypted, safely stored and always available on their on-chain wallet that lives on the permaweb - a decentralized, immutable and uncensorable Web 3.0.</p>
            <section>
